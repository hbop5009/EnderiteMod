		...
		if ((entity.getCapability(EnderiteModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (true) {
						...
						.orElse(new EnderiteModVariables.PlayerVariables())).enderite0);
				{
					...
					if (_ist.attemptDamageItem((int) Math.floor((((current_item)).getMaxDamage() - ((current_item)).getDamage()) / 2), new Random(),
							null)) {
						_ist.shrink(1);
						_ist.setDamage(0);
					}
				}
				if (ItemTags.getCollection().getTagByID(new ResourceLocation("forge:void_respawn")).contains((current_item).getItem())) {
					{
				...
				if (ItemTags.getCollection().getTagByID(new ResourceLocation("forge:void_respawn")).contains((current_item).getItem())) {
					if (entity instanceof LivingEntity) {
						if (entity instanceof PlayerEntity)
							...
							((LivingEntity) entity).setItemStackToSlot(EquipmentSlotType.HEAD, (current_item));
				...
				if (ItemTags.getCollection().getTagByID(new ResourceLocation("forge:void_respawn")).contains((current_item).getItem())) {
					if (entity instanceof LivingEntity) {
						if (entity instanceof PlayerEntity)
							...
							((LivingEntity) entity).setItemStackToSlot(EquipmentSlotType.CHEST, (current_item));
						if (entity instanceof ServerPlayerEntity)
							((ServerPlayerEntity) entity).inventory.markDirty();
					}
				}
				...
				if (ItemTags.getCollection().getTagByID(new ResourceLocation("forge:void_respawn")).contains((current_item).getItem())) {
					if (entity instanceof LivingEntity) {
						if (entity instanceof PlayerEntity)
							...
							((LivingEntity) entity).setItemStackToSlot(EquipmentSlotType.LEGS, (current_item));
						if (entity instanceof ServerPlayerEntity)
							((ServerPlayerEntity) entity).inventory.markDirty();
					}
				}
				...
				if (ItemTags.getCollection().getTagByID(new ResourceLocation("forge:void_respawn")).contains((current_item).getItem())) {
					if (entity instanceof LivingEntity) {
						if (entity instanceof PlayerEntity)
							...
							((LivingEntity) entity).setItemStackToSlot(EquipmentSlotType.FEET, (current_item));
						if (entity instanceof ServerPlayerEntity)
							((ServerPlayerEntity) entity).inventory.markDirty();
					}
				}
