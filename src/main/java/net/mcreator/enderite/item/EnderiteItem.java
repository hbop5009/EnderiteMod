...
public class EnderiteItem extends EnderiteModElements.ModElement {
	@ObjectHolder("enderite:enderite_helmet")
	public static final Item helmet = null;
	@ObjectHolder("enderite:enderite_chestplate")
	public static final Item body = null;
	@ObjectHolder("enderite:enderite_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "enderite:textures/models/armor/netherite__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
