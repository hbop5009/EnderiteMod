...
public class CrystallisedEndstoneBlock extends EnderiteModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystallised_endstone");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("enderite:crystallised_endstone_match"),
			...
			event.getRegistry().register(feature.setRegistryName("crystallised_endstone"));
